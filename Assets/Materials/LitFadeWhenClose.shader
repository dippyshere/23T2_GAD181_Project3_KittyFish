...
Shader "Universal Render Pipeline/Custom/Lit Fade when Close"
{
    Properties
    {
        _FadeEndDistance ("Minimum Distance", float) = 0.5
        _FadeLength ("Maximum Distance", float) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                // Fade depending on distance to camera
                float distanceFromCamera = distance(positionWS, _WorldSpaceCameraPos);
                surfaceData.alpha *= saturate((distanceFromCamera - _FadeEndDistance) / _FadeLength);
    ...
    // same properties.
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.LitFadeWhenCloseShader"
}